# snackbot.py — after Round 5 (final): mixed mode. One pinned deterministic read, deterministic writes, two agent-triggered search tools.
import json
import os
import sqlite3
import sys
...
def run_turn(user_msg: str) -> str:
    user_facts = read_user_facts()   # S5.1: pinned — the ONLY deterministic read
    messages = [
